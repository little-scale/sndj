...
| **4** | **Data1 / `$4017` bit 0** | **IN toggle / IN24 counter bit 0** |
| **5** | **Data2 / `$4017` bit 1** | **IN24 counter bit 1 only** |
...
have seven positions. This does not affect one-wire IN, but an IN24 adapter must
be continuity-tested specifically at pin 5 or fitted with an additional contact.
...
- Confirm the SNES Data1 level switches cleanly; for IN24, confirm Data2 as well.
